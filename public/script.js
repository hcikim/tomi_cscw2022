...
var Message = {
	...
	send: function(){
		...
		textForm.submit(function( event ) {
			...
			base.saveText();
			if(base.currentText != ''){
				socket.emit("chat", { group: current_group,
									msg: base.currentText,
									timestamp: Date.now() });
				base.createMessage();
				base.scrollDown();
...
//        		     thumber.on("pointerdown", function(){
//            	         Message.createGroup();
//         	         base.create();
//            	 	 base.expand();
//        		     });
...
var newReceivedMessage = Object.create(ReceivedMessage);
newReceivedMessage.init();
